...
async function handleNewClientSubmit(e) {
    ...
    const clientData = {
        ...
        attorney_name: document.getElementById('newAttorneyName').value || 'Jill R. Ginsberg',
        attorney_bar_no: document.getElementById('newAttorneyBarNo').value || '813850',
        attorney_email: document.getElementById('newAttorneyEmail').value || 'Jill@ginsbergshulman.com',
        attorney_phone: document.getElementById('newAttorneyPhone').value || '954-332-2310',
        attorney_address: document.getElementById('newAttorneyAddress').value || 'Ginsberg Shulman PL\n300 SE 2nd St Ste 600\nFort Lauderdale, FL 33301-1950',
